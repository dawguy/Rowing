...
public class ServerApplication {
  ...
  //            List<? extends Workout> waterWorkoutList =
  // workoutService.getWaterWorkoutsByAthlete(1);
  //            List<List<? extends Split>> waterSplitsList =
  // waterWorkoutList.stream().map(Workout::getSplits).collect(Collectors.toList());
