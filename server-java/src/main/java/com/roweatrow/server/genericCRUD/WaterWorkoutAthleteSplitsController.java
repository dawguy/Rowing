...
public class WaterWorkoutAthleteSplitsController {
  ...
  public @ResponseBody WaterWorkoutAthleteSplit getWaterWorkoutAthleteSplit(
      @PathVariable Long waterWorkoutAthleteSplitId) {
    Optional<WaterWorkoutAthleteSplit> waterWorkoutAthleteSplit =
        waterWorkoutAthleteSplitRepository.findById(waterWorkoutAthleteSplitId);
    return waterWorkoutAthleteSplit.orElse(null);
  }

  @PostMapping(value = "")
  public @ResponseBody WaterWorkoutAthleteSplit createWaterWorkoutAthleteSplit(
      @RequestBody WaterWorkoutAthleteSplit requestBody) {
    if (requestBody.getWaterWorkoutAthleteSplit() != null) {
      Optional<WaterWorkoutAthleteSplit> waterWorkoutAthleteSplit =
          waterWorkoutAthleteSplitRepository.findById(requestBody.getWaterWorkoutAthleteSplit());
