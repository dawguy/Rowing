...
public class BoatsController {
  ...
  public BoatsController(BoatRepository boatRepository) {
    this.boatRepository = boatRepository;
  }

  @GetMapping(value = "/{boatId}")
  public @ResponseBody Boat getBoat(@PathVariable Long boatId) {
    Optional<Boat> boat = boatRepository.findById(boatId);
    return boat.orElse(null);
  }

  @PostMapping(value = "")
  public @ResponseBody Boat createBoat(@RequestBody Boat requestBody) {
