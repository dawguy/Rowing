...
public class PowerProfileSegmenter {
  ...
  // The goal of splitting splits to unit duration segments is that it will allow precise
  // calculation of average power
  // at any point in time without any additional algorithmic complexity. Using non-unit segments
  // would allow you to
  // still calculate the correct maximums per time duration, but the in-between averages wouldn't be
  // calculable.
