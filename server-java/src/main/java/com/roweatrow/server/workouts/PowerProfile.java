...
public class PowerProfile {
  private final List<PowerProfileSegment> splitSegmentList;
  private final List<PowerProfileSegment> powerProfileSegmentList;

  public PowerProfile(
      List<PowerProfileSegment> splitSegmentList,
      List<PowerProfileSegment> powerProfileSegmentList) {
