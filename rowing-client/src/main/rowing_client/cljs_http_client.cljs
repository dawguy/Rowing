; https://raw.githubusercontent.com/r0man/cljs-http/master/src/cljs_http/client.cljs
(ns rowing-client.cljs-http-client
  (:refer-clojure :exclude [get])
  (:require [rowing-client.cljs-http-core :as core]
            [rowing-client.cljs-http-util :as util]
...
(comment
  ...
  (ns example.core
    (:require [rowing-client.cljs-http-client :as http]
